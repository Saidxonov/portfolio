        ...
        <TooltipProvider delayDuration={0}>
          <Tooltip>
            <TooltipTrigger
              ...
              onClick={() => {
                window?.open("https://t.me/saidburxon_jorayev", "_blank");
              }}
            >
              <svg
        ...
        <TooltipProvider delayDuration={0}>
          <Tooltip>
            <TooltipTrigger
              ...
              onClick={() => {
                window?.open(
                  "mailto:mirzoulugbekkhudoyberdiyev@gmail.com?subject=Mirzo Ulug'bekga xat"
                );
              }}
            >
              <svg
        ...
        <TooltipProvider delayDuration={0}>
          <Tooltip>
            <TooltipTrigger
              ...
              onClick={() => {
                window?.open("https://github.com/saidxonov", "_blank");
              }}
            >
              <GitHubLogoIcon />
            </TooltipTrigger>
      ...
      <li>
        <TooltipProvider delayDuration={0}>
          <Tooltip>
            ...
            <TooltipContent side="bottom">
              <p>Rezyumeni ko'rmoqchimisiz? Atiga bir click</p>
            </TooltipContent>
          </Tooltip>
        </TooltipProvider>
      </li>
